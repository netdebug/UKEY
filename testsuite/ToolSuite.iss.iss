...
AppVerName={cm:MyAppVerName,2.0.4.025}
...
VersionInfoVersion=2.0.4.025
OutputBaseFilename=SafeCertSetupV2.0.4.025
OutputDir=.\output
...
Source: "..\bin\extern\seals\*"; DestDir: "{app}"; Flags: recursesubdirs;
